...
<body>
	<div class="mycontainer">
		...
		<div class="bodystyle">
			<form:form action="/empapp/delemp" method="POST"
					...
					<table style="width: 212px;">
						...
						<c:forEach var="listvar" items="${list}">
							<tr bgcolor="#eee">
								<td>${listvar.eid}</td>
								<td>${listvar.name}</td>
								<td>${listvar.salary}</td>
								
								<form:form action="/empapp/delemplist" method="POST" commandName="employeeDelListDTO">	
									<td> <form:checkbox path="employeeDelList" value="narnedra" />  </td>	
									<td> <input name="delete" type="submit" value="Delete"> </td>
									<td> "${employeeDelList}" </td>
					 			 </form:form>
							</tr>
						</c:forEach>
...
<%-- 						<form:form action="/empapp/delemplist" method="POST"
									commandName="employeeDelListDTO">		
						 	<td> <form:checkboxes path="employeeDelList" items="${list}" /> </td>	
							<td> <input name="delete" type="submit" value="Delete"> </td>
					 	 </form:form>  --%>
